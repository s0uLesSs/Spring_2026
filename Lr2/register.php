...
<section class="account d-flex">
    ...
    <div class="account__right padding-t-120 flx-align">
        <div class="account-content">
            <a href="index.php" class="logo mb-64">  
                <img src="assets/images/logo/logo.png" alt="">
            </a>
            <h4 class="account-content__title mb-48 text-capitalize">Создание аккаунта</h4>
            <span style="color:red; margin-bottom:30px"><?php echo $_SESSION['message']; unset($_SESSION['message']); ?></span>
            <form action="events_user/signup.php" method="post">
                <div class="row gy-4">
                    <div class="col-12">
                        <label for="name" class="form-label mb-2 font-18 font-heading fw-600">ФИО</label>
                        <div class="position-relative">
                            <input type="text" class="common-input common-input--bg common-input--withIcon" id="FIO" name="FIO" placeholder="Введите ФИО">
                    ...
                    <div class="col-12">
                        <label for="your-password" class="form-label mb-2 font-18 font-heading fw-600">Подтвердите пароль</label>
                        <div class="position-relative">
                            <input type="password" class="common-input common-input--bg common-input--withIcon" id="password2" name="password2" placeholder="Введите пароль">
                            <span class="input-icon toggle-password cursor-pointer" id="#your-password"><img src="assets/images/icons/lock-icon.svg" alt=""></span>
                        </div>
                    </div>
                    
                    <div class="col-12">
                        <button type="submit" class="btn btn-main btn-lg w-100 pill">Создать аккаунт</button>
                    </div>
                    
                    <div class="col-sm-12 mb-0">
                        <div class="have-account">
                            <p class="text font-14">Уже есть аккаунт? <a class="link text-main text-decoration-underline  fw-500" href="index.php?page=login">Войти</a></p>
                        </div>
                    </div>
                </div>
            </form>
